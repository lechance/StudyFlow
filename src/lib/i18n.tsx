...
const zh: Record<string, string> = {
  ...
  // Check-in page
  'checkin.title': '学习打卡',
  'checkin.subtitle': '记录你的学习足迹，见证成长',
  'checkin.checkInNow': '立即打卡',
  'checkin.alreadyCheckedIn': '今日已打卡',
  'checkin.streakDays': '连续打卡天数',
  'checkin.keepGoing': '保持专注',
  'checkin.smallProgress': '每天进步一点点',
  'checkin.greatStreak': '太棒了！继续保持',
  'checkin.amazingStreak': '你太厉害了！21天习惯养成',
  'checkin.startStreak': '开始你的连续打卡之旅',
  'checkin.todayProgress': '今日任务完成情况',
  'checkin.tasksCompleted': '任务已完成',
  'checkin.moreTasks': '更多任务...',
  'checkin.noTasksToday': '今日暂无计划任务',
  'checkin.addTasksFromTasksPage': '去任务页面添加今日计划',
  'checkin.weekOverview': '本周打卡概览',
  'checkin.today': '今天',
  'checkin.weekCheckins': '本周打卡',
  'checkin.weekTasks': '完成任务',
  'checkin.weekHours': '学习时长',
  'checkin.motivationTitle': '学习提示',
  'checkin.motivationStart': '每天完成学习计划并打卡，21天养成好习惯。连续打卡天数越多，学习动力越强！',
  'checkin.motivationGreat': '太棒了！你已经连续打卡7天以上，学习习惯正在养成。继续保持！',
  'checkin.motivationExpert': '太厉害了！你已连续打卡21天以上，学习习惯已养成！继续保持！',
...
const en: Record<string, string> = {
  ...
  // Check-in page
  'checkin.title': 'Study Check-in',
  'checkin.subtitle': 'Track your learning journey, witness your growth',
  'checkin.checkInNow': 'Check In Now',
  'checkin.alreadyCheckedIn': 'Checked In Today',
  'checkin.streakDays': 'Streak Days',
  'checkin.keepGoing': 'Keep Going',
  'checkin.smallProgress': 'Make progress every day',
  'checkin.greatStreak': 'Great job! Keep it up!',
  'checkin.amazingStreak': 'Amazing! 21-day habit formed!',
  'checkin.startStreak': 'Start your check-in streak',
  'checkin.todayProgress': "Today's Task Progress",
  'checkin.tasksCompleted': 'tasks completed',
  'checkin.moreTasks': 'more tasks...',
  'checkin.noTasksToday': 'No planned tasks for today',
  'checkin.addTasksFromTasksPage': 'Go to Tasks page to add today plan',
  'checkin.weekOverview': 'Week Check-in Overview',
  'checkin.today': 'Today',
  'checkin.weekCheckins': 'Week Check-ins',
  'checkin.weekTasks': 'Tasks Done',
  'checkin.weekHours': 'Study Hours',
  'checkin.motivationTitle': 'Learning Tip',
  'checkin.motivationStart': 'Complete your study plan and check in daily. 21 days to build a habit!',
  'checkin.motivationGreat': "Great! You've checked in for 7+ days. Keep building that habit!",
  'checkin.motivationExpert': "Incredible! 21+ days streak! Your learning habit is solidified!",

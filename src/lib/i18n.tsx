...
const zh: Record<string, string> = {
  ...
  'recycle.permanentlyDelete': '永久删除',
  'recycle.tip': '温馨提示',
  ...
  'settings.storageConfig': 'S3 存储配置',
  'settings.storageDesc': '配置 S3 兼容的对象存储服务，实现数据持久化',
  'settings.enableStorage': '启用 S3 存储',
  'settings.enableStorageDesc': '启用后将使用 S3 存储您的数据',
  'settings.endpointUrl': 'Endpoint URL',
  'settings.endpointHint': '支持 AWS S3、阿里云 OSS、MinIO 等 S3 兼容存储',
  'settings.accessKey': 'Access Key',
  'settings.enterAccessKey': '请输入 Access Key',
  'settings.secretKey': 'Secret Key',
  'settings.enterSecretKey': '请输入 Secret Key',
  'settings.bucketName': 'Bucket 名称',
  'settings.enterBucketName': '请输入 Bucket 名称',
  'settings.region': '区域',
...
const en: Record<string, string> = {
  ...
  'recycle.permanentlyDelete': 'Permanently Delete',
  'recycle.tip': 'Tips',
  ...
  'settings.storageConfig': 'S3 Storage Configuration',
  'settings.storageDesc': 'Configure S3-compatible object storage for data persistence',
  'settings.enableStorage': 'Enable S3 Storage',
  'settings.enableStorageDesc': 'Use S3 storage to persist your data',
  'settings.endpointUrl': 'Endpoint URL',
  'settings.endpointHint': 'Supports AWS S3, Alibaba Cloud OSS, MinIO and other S3-compatible storage',
  'settings.accessKey': 'Access Key',
  'settings.enterAccessKey': 'Enter Access Key',
  'settings.secretKey': 'Secret Key',
  'settings.enterSecretKey': 'Enter Secret Key',
  'settings.bucketName': 'Bucket Name',
  'settings.enterBucketName': 'Enter Bucket Name',
